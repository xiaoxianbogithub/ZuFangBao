<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="自营门店/品牌公寓/商铺办公" prop="name">
        <el-input
          v-model="queryParams.name"
          placeholder="请输入自营门店/品牌公寓/商铺办公"
          clearable
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['residence:category:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['residence:category:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['residence:category:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['residence:category:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="categoryList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="自营门店/品牌公寓/商铺办公" align="center" prop="name" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="自营门店/品牌公寓/商铺办公" prop="name">
          <el-input v-model="form.name" placeholder="请输入自营门店/品牌公寓/商铺办公" />
        </el-form-item>
        <el-form-item label="0: 隐藏;1:显示" prop="display">
...
<script>
import { listCategory, getCategory, delCategory, addCategory, updateCategory } from "@/api/residence/category";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除房源分类编号为"' + ids + '"的数据项？').then(function() {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('residence/category/export', {
        ...this.queryParams
